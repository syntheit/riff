...
impl CardModel {
    ...
    /// Whether this item is locally pinned. Pinned items float to the top of the
    /// library list regardless of the active sort order. (`set_pinned` is
    /// generated by the `pinned` glib property.)
